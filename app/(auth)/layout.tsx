    ...
    <>
      ...
      <main className="relative flex grow">
        <div
          ...
          aria-hidden="true"
        >
          <div className="h-80 w-80 rounded-full bg-linear-to-tr from-[var(--color-brand-500)] opacity-70 blur-[160px]"></div>
        </div>
        ...
        <>
          ...
          <div className="relative my-6 mr-6 hidden w-[572px] shrink-0 overflow-hidden rounded-2xl lg:block">
            {/* Background */}
            <div
              className="pointer-events-none absolute left-1/2 top-1/2 -z-10 -ml-24 -translate-x-1/2 -translate-y-1/2 bg-[color:var(--color-brand-200)]"
              aria-hidden="true"
            >
              <Image
                src={AuthBg}
