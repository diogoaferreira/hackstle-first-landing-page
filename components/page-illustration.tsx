  ...
  return (
    <>
      ...
      <div
        ...
        aria-hidden="true"
      >
        <div className="h-80 w-80 rounded-full bg-linear-to-tr from-[var(--color-brand-500)] opacity-50 blur-[160px]" />
      </div>
      <div
        className="pointer-events-none absolute left-1/2 top-[420px] ml-[380px] -translate-x-1/2"
        aria-hidden="true"
      >
        <div className="h-80 w-80 rounded-full bg-linear-to-tr from-[var(--color-brand-500)] to-gray-900 opacity-50 blur-[160px]" />
      </div>
      <div
